...
fun box(): String {
  ...
  if (listDescriptor.pType.kClass != List::class) return "FAIL: List<Person> kClass"
  ...
  if (personArg.introspectionData!!.kClass != Person::class) return "FAIL: Person arg introspectionData.kClass"
